...
- **CAPTCHA Ja/Nein?** – V1.0 startet ohne CAPTCHA (UX vor Sicherheit in dieser Phase). Honeypot + Rate-Limit reichen für den Pilot. Wenn echte Spam-Flut entsteht, nachrüsten mit hCaptcha.
